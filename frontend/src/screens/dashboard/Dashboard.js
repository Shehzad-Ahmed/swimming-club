...
// Thanks to https://themewagon.com/themes/purple-react-free-react-bootstrap-4-admin-dashboard-template/

const Dashboard = () => {
  const [startDate, setStartDate] = useState(null);
  const [visitSaleData, setVisitSaleData] = useState({datasets: []});
  ...
  const [trafficData, setTrafficData] = useState({datasets: []});
          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body">
                <img src={require("./assets/circle.svg")} className="card-img-absolute" alt="circle" />
                ...
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src={require("./assets/faces/face1.jpg")} className="mr-2" alt="face" /> David Grey </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("./assets/faces/face2.jpg")} className="mr-2" alt="face" /> Stella Johnson </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("./assets/faces/face3.jpg")} className="mr-2" alt="face" /> Marina Michel </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("./assets/faces/face4.jpg")} className="mr-2" alt="face" /> John Doe </td>
              ...
              <div className="card-body">
                ...
                <div className="row mt-3">
                  <div className="col-6 pr-1">
                    <img src={require("./assets/img_1.jpg")} className="mb-2 mw-100 w-100 rounded" alt="face" />
                    <img src={require("./assets/img_4.jpg")} className="mw-100 w-100 rounded" alt="face" />
                  </div>
                  <div className="col-6 pl-1">
                    <img src={require("./assets/img_2.jpg")} className="mb-2 mw-100 w-100 rounded" alt="face" />
                    <img src={require("./assets/img_3.jpg")} className="mw-100 w-100 rounded" alt="face "/>
                  </div>
                </div>
                <div className="d-flex mt-5 align-items-start">
                  <img src={require("./assets/faces/face3.jpg")} className="img-sm rounded-circle mr-3" alt="face" />
